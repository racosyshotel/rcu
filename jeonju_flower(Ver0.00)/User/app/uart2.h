...
//기구물 통신 장애 파악 변수 설정 2020.11.12 (신규 추가)
...
//DTC Dip switch 기능 추가 2021.01.20
...
const u8 b_sub_device_table[][12] = {
  {B_CHIME_IND, B_KEY_SENSOR_0, B_LIGHT_SWITCH_1,B_GIGA, B_TEMP_SENSOR_1,0xff,0xff,0xff}, //RCB - 1 (CB_MODE 0) 
...
{
  {
    { K_stand_1, K_stand_2, K_stand_3, K_stand_4, K_stand_5, K_stand_master }, // LIGHT STAND SW 1 (ID 0) 6구 1,2,3,4,5,M
  }, //RCB - 1(CB MODE 0)
  {
     { K_stand_1, K_stand_2, K_stand_master, K_stand_3, K_stand_4, K_stand_master },    // LIGHT STAND SW 1 (ID 0) 6구 1,2,3,4,M
     { K_stand_1, K_stand_2, K_stand_master, K_stand_3, K_stand_4, K_stand_master }     // LIGHT STAND SW 2 (ID 0) 6구 1,2,3,4,M
  }  //RCB - 2(CB MODE 1)
};
