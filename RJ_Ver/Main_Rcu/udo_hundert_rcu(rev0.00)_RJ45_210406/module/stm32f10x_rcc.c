...
{
  /* Set HSION bit */
  RCC->CR |= (u32)0x00000001;   //000000 0 0 0000 0 0 0 0 00000000 00000 0 0 1

  /* Reset SW[1:0], HPRE[3:0], PPRE1[2:0], PPRE2[2:0], ADCPRE[1:0] and MCO[2:0] bits */
  RCC->CFGR &= (u32)0xF8FF0000; //11111 000 1 1 1111 1 1 00 000 000 0000 00 00
  
  /* Reset HSEON, CSSON and PLLON bits */
  RCC->CR &= (u32)0xFEF6FFFF;   //111111 1 0 1111 0 1 1 0 11111111 11111 1 1 1

  /* Reset HSEBYP bit */
  RCC->CR &= (u32)0xFFFBFFFF;   //111111 1 1 1111 1 0 1 1 11111111 11111 1 1 1

  /* Reset PLLSRC, PLLXTPRE, PLLMUL[3:0] and USBPRE bits */
  RCC->CFGR &= (u32)0xFF80FFFF; //11111 111 1 0 0000 0 0 11 111 111 1111 11 11
