...
const u16 b_cb_send_id_table[4][800] = {
 {
...
const u16 dectbl1000[] = { 0x00, 0x4096, 0x8192, 0, };
const u16 dectbl100[] =  { 0x00, 0x256, 0x512, 0x768, 0x1024, 0x1280, 0x1536, 0x1792, 0x2048, 0x2304, 0x2560, 0x2816, 0x3072, 0x3328, 0x3584, 0x3840 };
const u16 dectbl10[] = 	 { 0x00, 0x16,  0x32,  0x48,  0x64,   0x80,   0x96,   0x112,  0x128,  0x144,	0x160,  0x176,  0x192,  0x208,  0x224,  0x240 };
const u16 dectbl1[] = 	 { 0x00,	0x01,	 0x02,  0x03,  0x04,   0x05,   0x06,   0x07,   0x08,   0x09,   0x10,   0x11,   0x12,   0x13,   0x14,   0x15 };
...
u2EX u8  cb_send_data_buf[cb_max_count][45];

u2EX u8 common_data_buf[45];
