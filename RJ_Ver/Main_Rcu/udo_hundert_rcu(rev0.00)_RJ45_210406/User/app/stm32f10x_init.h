...
/******************************** structure ***********************************************/
// RCS-310-RJ rev1.0 Port redefine  2017.6.26 hhh


#define led5		      GpioB->Bit.b8   //o**
#define led4		      GpioB->Bit.b9   //o**
#define led3   	      GpioE->Bit.b0   //o**
#define led2  		    GpioE->Bit.b1  //o**
#define led1  		    GpioE->Bit.b2  //o**

#define P_UART3_DIR		GpioE->Bit.b15  //o**

#define tcrst   	    GpioD->Bit.b7   //n

//========= Relay port1 define =========
#define P_rly_1     GpioB->Bit.b15    //cn2.1 //o**
#define P_rly_2     GpioB->Bit.b14    //cn2.2 //o**
#define P_rly_3     GpioB->Bit.b13    //cn2.3 //o**
#define P_rly_4     GpioB->Bit.b12    //cn2.4 //o**
#define P_rly_5     GpioE->Bit.b14    //cn2.5 //o**
#define P_rly_6     GpioE->Bit.b13    //cn2.6 //o**
#define P_rly_7     GpioE->Bit.b12    //cn2.7 //o**
#define P_rly_8     GpioE->Bit.b11    //cn2.8 //o**

#define P_rly_9     GpioD->Bit.b15    //cn3.1 //n
#define P_rly_10    GpioD->Bit.b14    //cn3.2 //n
#define P_rly_11    GpioD->Bit.b13    //cn3.3 //n
#define P_rly_12    GpioD->Bit.b12    //cn3.4 //n
#define P_rly_13    GpioD->Bit.b11    //cn3.5 //n
#define P_rly_14    GpioD->Bit.b10    //cn3.6 //n
#define P_rly_15    GpioD->Bit.b9     //cn3.7 //n
#define P_rly_16    GpioD->Bit.b8     //cn3.8 //n

#define P_ex_led1   GpioC->Bit.b10    //cn4.1 //o**
#define P_ex_led2   GpioA->Bit.b15    //cn4.2 //o**
#define P_ex_led3   GpioA->Bit.b12    //cn4.3 //o**
#define P_ex_led4   GpioA->Bit.b11    //cn4.4 //o**
#define P_ind_led   GpioC->Bit.b9    //cn4.5  //o**
#define P_ks_led    GpioC->Bit.b8    //cn4.6  //o**
#define P_dnd_led   GpioC->Bit.b7    //cn4.7  //o**
#define P_mur_led   GpioC->Bit.b6    //cn4.8  //o**

#define P_ks_A              GpioE->Bit.b4   //i**
#define P_ks_B              GpioE->Bit.b5   //i**
#define P_emergency_sw      GpioE->Bit.b6   //i**
#define P_door_sw           GpioC->Bit.b13  //i**
#define P_enterance_switch  GpioC->Bit.b0   //i**
#define P_dnd_switch        GpioC->Bit.b1   //i**
#define P_mur_switch        GpioC->Bit.b2   //i**
#define P_chime_switch      GpioC->Bit.b3   //i**

#define P_chime_mute        GpioA->Bit.b6   //o**
#define P_chime_out         GpioA->Bit.b4   //o**
#define P_alarm_out         GpioA->Bit.b5   //o**

#define P_24lcxx_enable     GpioD->Bit.b4   //n

#define P_dip_0             GpioE->Bit.b8   //i**
#define P_dip_1             GpioE->Bit.b7   //i**
#define P_dip_2             GpioB->Bit.b2   //i**
#define P_dip_3             GpioB->Bit.b1   //i**
#define P_dip_4             GpioB->Bit.b0   //i**
#define P_dip_5             GpioC->Bit.b5   //i**
#define P_dip_6             GpioC->Bit.b4   //i**
#define P_dip_7             GpioA->Bit.b7   //i**

#define P_dip_rd_0          GpioE->Bit.b9   //o**
#define P_dip_rd_1          GpioE->Bit.b10  //o**

#define P_volum_sck         GpioB->Bit.b4   //n
#define P_volum_data        GpioB->Bit.b3   //n
#define P_volum_sc_0        GpioD->Bit.b2   //n

#define P_ex_input_0        GpioE->Bit.b3    //cn5.1  //i**
#define P_ex_input_1        GpioE->Bit.b2    //cn5.2  //i**
#define P_ex_input_2        GpioE->Bit.b1    //cn5.3  //i**  
#define P_ex_input_3        GpioE->Bit.b0    //cn5.4  //i**
#define P_ex_input_4        GpioB->Bit.b9    //cn5.5  //i**
#define P_ex_input_5        GpioB->Bit.b8    //cn5.6  //i**
#define P_ex_input_6        GpioB->Bit.b5    //cn5.7  //i**
#define P_ex_input_7        GpioD->Bit.b6    //cn5.8  //i**
...
#define P_emergency_sw      GpioC->Bit.b7
#define P_door_sw           GpioC->Bit.b6
#define P_enterance_switch  GpioB->Bit.b15
#define P_dnd_switch        GpioB->Bit.b14
#define P_mur_switch        GpioB->Bit.b13
...
itEx u16  indicator_timer;

itEx u8   u3_dir_delay_counter;


itEx u8   dip_mode;
itEx u8   dip_mode_count;

itEx u16  handy_sign_timer;
itEx u16  handy_sign_timer_2;
itEx u8   cb_mode;
itEx u16   guest_alrm_timer_1;
itEx u16   guest_alrm_timer_2;
itEx u8   f_dnd_ok;
itEx u16  dnd_count; 
...
itEx u16  power_reset_timer;
itEx u8   f_test_mode;
itEx u16  tnt_reset_timer;
itEx u8   ts_id;
itEx u8   ondol_set_flag[4];
itEx u16  f_uart3_data_send_time;
itEx u8   curtain_state[2];
itEx u16  fan_control_timer;
itEx u8   f_bath_control;               //재실시 화장실 전등 on/off flag
itEx u16  curtain_open_timer;
itEx u16  clean_timer;
itEx u8   clean_ok_flag;

itEx __dwbits itflag1;
#define f_indicator_timer			itflag1.s.b0
#define f_handy_sign    			itflag1.s.b1
