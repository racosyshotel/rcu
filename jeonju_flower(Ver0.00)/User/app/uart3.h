...
void ss_air_status(unsigned char address);
...
/***************************************************/
//SAMSUNG Aircon Protocol Data Define
/**************************************************/

#define STX_SSAIR       0x32
#define ETX_SSAIR       0x34
#define SSAIR_COMMAND   0xc0
#define SSAIR_CONTROL_MONITOR   0x40

#define SS_enumeration          0x00
#define SS_variable             0x02
#define SS_long_variable        0x04
#define SS_structure            0x06


#define SS_COMMAND_state_standby      0x00
#define SS_COMMAND_state_normal       0x10

#define SS_COMMAND_type_read            0x01
#define SS_COMMAND_type_write           0x02
#define SS_COMMAND_type_request         0x03
#define SS_COMMAND_type_nofication      0x04
#define SS_COMMAND_type_response        0x05
#define SS_COMMAND_type_Ack             0x06




#define SS_ONOFF                0x01
#define SS_SET_TEMP             0x02
#define SS_FAN_SPEED            0x03
#define SS_REMOCON_SENSOR       0x04
#define SS_BUZZER               0x05
#define SS_CONTROL_MODE         0x06
//=======================================================================
...
//SAMSUNG PLC Aircon define
u3EX u8 ss_packet_counter;
u3EX u8 ss_data_counter;

u3EX u8 ss_onoff_status[50];
u3EX s16 ss_set_temp[50];
u3EX u8 ss_fan_speed[50];
u3EX u8 ss_buzzer[50];
u3EX s16 ss_remocon_sensor_temp[50];
u3EX u8 ss_control_mode[50];
u3EX u16 ss_error_code[50];
u3EX u8  room_temperatur_rev[6];
u3EX u8  room_temperature[2];
u3EX u8  air_ad_save[4];

u3EX u8 ss_air_address[50];
u3EX u8 ss_control_monitor[50];
u3EX u8 f_uart3_com_start;
u3EX u8 f_ss_power_on[50];
u3EX u8 ss_air_control;

u3EX u16 ss_set_temp_dec;
u3EX u16 ss_rx_set_temp;

u3EX u8 ss_outdoor_address[50];
u3EX u8  f_plc_add_toggle[4];
u3EX u8  aircon_no_respones[4];
u3EX u8  f_address_set_ok;
u3EX u8  f_send_tempsensor_data;
u3EX u8  f_ss_first_addr;
...
u3EX __bits uart3_ss;
#define f_uart3_data_send_2_ss uart3.s.b0
#define f_uart3_data_send_3_ss uart3.s.b1
#define f_uart3_data_send_4_ss uart3.s.b2
...
u3EX __bits uart3_sub;
#define f_uart3_data_send_4 uart3_sub.s.b0
#define f_uart3_data_send_ok uart3_sub.s.b1

u3EX __bits ss_flag;

#define f_ss_send_eco_x  ss_flag.s.b2
#define f_ss_reset       ss_flag.s.b3
//=======================================================================
