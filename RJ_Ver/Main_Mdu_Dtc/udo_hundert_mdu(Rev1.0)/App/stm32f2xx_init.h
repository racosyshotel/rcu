...
//#define CLK_24MHZ         //2.4V    :220mA, 46mA  (LCD ¼Óµµ ´À·ÁÁü)     
//#define CLK_16MHZ         //2.4V   :220mA, 40mA  (LCD ¼Óµµ ´À·ÁÁü)         
...
itEX u8 sign_led_pc_tx;
itEX u8 sign_led_pc_rx;
itEX u8 sign_led_sys_tx;
itEX u8 sign_led_sys_rx;
itEX u8 sign_led_ex_tx;
itEX u8 sign_led_ex_rx;
...
itEX __bits stm32_init_2;
#define f_power_on      stm32_init_2.bit.b0

itEX __bits sign_led_flag;
#define f_sign_pc_tx    sign_led_flag.bit.b0
#define f_sign_pc_rx    sign_led_flag.bit.b1
#define f_sign_sys_tx   sign_led_flag.bit.b2
#define f_sign_sys_rx   sign_led_flag.bit.b3
#define f_sign_ex_tx    sign_led_flag.bit.b4
#define f_sign_ex_rx    sign_led_flag.bit.b5
#define f_sign_power    sign_led_flag.bit.b6
